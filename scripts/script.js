$(document).ready(function() {
  ...
  var mainCategory = {
    "terveys-ja-apteekki": [
      "allergia",
      "kipu-ja-flunssa",
      "lapset-aitiys-ja-raskaus",
      "elaimet"
    ],
    "kauneus-ja-ihonhoito": [
      "aurinkotuotteet",
      "hiustenhoito",
      "ihonhoito-kasvot",
      "meikit"
    ],
    "hyvinvointi-ja-ravinto": [
      "laihdutus-ja-painonhallinta",
      "proteiini-ja-muut-lisaravinteet",
      "superfood"
    ]
  };
  ...
  var secondaryCategory = {
    allergia: [
      "antihistamiini-ja-kortisoni-suun-kautta",
    ...
    "kipu-ja-flunssa": [
      "kipu-ja-kuume",
      "kurkkukipu-ja-aanen-kaheys",
      "nenasumute-tukkoisuus",
      "yskanlaake"
    ],
    "lapset-aitiys-ja-raskaus": [
      "imetys-1",
    ...
    aurinkotuotteet: [
      "aurinkovoide-kasvoille",
      "aurinkovoide-lapsille",
      "auringonoton-jalkeen",
      "aurinkovoide-vartalolle"
    ],
    hiustenhoito: [
      "hiustarvikkeet",
      "shampoo-ja-kuivashampoo",
      "hoitoaine",
      "hiusvarit"
    ],
    "ihonhoito-kasvot": [
      ...
      "atooppinen-iho",
      "ihonpuhdistus",
      "kasvojen-puhdistuslaitteet"
    ],
    meikit: ["kasvomeikit", "meikkaustarvikkeet", "silmameikit", "kynnet"],
    "laihdutus-ja-painonhallinta": [
      "laihdutuslaake-ja-muut-valmisteet-laihdutukseen",
      "vahaenerginen-dieetti-vlcd-ateriankorvikkeet",
      "rasvanpolttajat",
      "puhdistus-paasto-ja-detox"
    ],
    "proteiini-ja-muut-lisaravinteet": [
      "proteiini-ja-massanlisays",
      "juomat-ja-jauheet-energiaan",
      "aminohappovalmisteet",
      "tehonlisaajat"
    ],
    superfood: [
      "marjajauheet-ja-supermarjat",
      "muut-superfood-jauheet-ja-tuotteet",
      "raakakaakao",
      "viherjauheet-ja-tabletit"
    ]
  };
  ...
  var buildCard = function(num, arrArg, txtArg) {
    ...
    arrArg.forEach(function(value) {
      $("#" + aSelectId[num]).append($("<option></option>").text(value));
    });
  };
