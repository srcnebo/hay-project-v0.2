$(document).ready(function() {
  ...
  var buildCard = function(num, arrArg, txtArg) {
    ...
    $('#' + aSelectId[num]).append($("<option selected='true' disabled='disabled'>Select</option>"));
  ...
  var buildFollowUpCards1 = function() {
    ...
    buildCard(1, mainCategory[selectedvalue], 'Please Choose 2nd Category');
  ...
  var buildFollowUpCards2 = function() {
    ...
    queryUrl += '/' + selectedvalue;
    buildCard(2, secondaryCategory[selectedvalue], 'Please Choose last Category');
    swiper.slideNext(2000);
  };
  ...
  buildCard(0, aMainCat, 'Please Choose a Category');
